                ...
                $('#saveData').click(function(){
                    if($('#subject').val() == "" || $('#description').val() == "")
                        ...
                        $.ajax({
                            url: "validate.php",
                            type: "POST",
                            data:{subjectAdd:$('#subject').val(),
                                descriptionAdd:$('#description').val()},
                            success: function(result){
                                if(result == 1){
                                    alert("Subject added or modified successfully!");
                                    window.open("subjectsShow.php", "_self");
                                }else
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="row">
                        ...
                        <br><br><br>
                        <div class="mb-3">
                            <label for="cedula" class="form-label">Subject Name</label>
                            <input type="text" class="form-control" id="subject" value="<?php if(!$_SESSION['isAddingSub']) echo $_SESSION['subMod']?>">
                        </div>
                        <div class="mb-3">
                            <label for="fullName" class="form-label">Description</label>
                            <input type="text" class="form-control" id="description" value="<?php if(!$_SESSION['isAddingSub']) echo $_SESSION['desMod']?>">
                        </div>
