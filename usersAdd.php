                    ...
                    $('#email').val() == "" || $('#password').val() == "")
                        ...
                        $.ajax({
                            ...
                            success: function(result){
                                if(result == 1){
                                    alert("User added or modified successfully!");
                ...
                <main>
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="cedula" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['cedulaMod']?>">
                        </div>
                        <div class="mb-3">
                            <div class="col">
                                <label for="fullName" class="form-label">Name 1</label>
                                <input type="text" class="form-control" id="name1" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['nam1Mod']?>">
                            </div>
                            <div class="col">
                                <label for="fullName" class="form-label">Name 2</label>
                                <input type="text" class="form-control" id="name2" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['nam2Mod']?>">
                            </div>
                            <div class="col">
                                <label for="fullName" class="form-label">LastName 1</label>
                                <input type="text" class="form-control" id="lastname1" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['lasnam1Mod']?>">
                            </div>
                            <div class="col">
                                <label for="fullName" class="form-label">LastName 2</label>
                                <input type="text" class="form-control" id="lastname2" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['lasnam2Mod']?>">
                            </div>
                        </div>
                        <div class="mb-3">
                            <label for="homeAdd" class="form-label">Home Address</label>
                            <input type="text" class="form-control" id="homeAdd" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['home2Mod']?>">
                        </div>
                        <div class="mb-3">
                            <label for="email" class="form-label">Email address</label>
                            <input type="email" class="form-control" id="email" aria-describedby="emailHelp" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['email2Mod']?>">
                        </div>
                        <div class="mb-3">
                            <label for="password" class="form-label">Password</label>
                            <input type="password" class="form-control" id="password" value="<?php if(!$_SESSION['isAdding']) echo $_SESSION['pass2Mod']?>">
                        </div>
