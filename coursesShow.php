    ...
    <head>
        ...
        <script>
            $(document).ready(function(){ 
                $('#add').click(function(){
                    // alert("id subject: " + $( "#sub" ).val());
                    // alert("id teacher: " + $( "#tea" ).val());
                    $.ajax({
                        url: "validate.php",
                        type: "POST",
                        data:{id_sub_course:$( "#sub" ).val(),
                            id_tea_course:$( "#tea" ).val()},
                        success: function(result){
                            alert(result);
                            window.open("coursesShow.php", "_self");
                        }
                    });
                });
                ...
                $('#update').click(function(){
                    ...
                    $.ajax({
                        url: "validate.php",
                        type: "POST",
                        data:{id_cour_update:$( "#cour" ).val(),
                            id_tea_update:$( "#tea" ).val()},
                        success: function(result){
                            alert(result);
                            window.open("coursesShow.php", "_self");
                        }
            ...
            <div id="layoutSidenav_content">                
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Courses Mananger</h1>
                        <h3 class="mt-4">Adding a course</h3>
                        <div class="col-6">
                            <?php
                                include_once("validate.php"); 
                                echo graphCourses();
                        ...
                        <button class="btn btn-success save" id="add">Add Course</button>
                        <br><br><br><br>
                        <h3 class="mt-4">Set a free course</h3>
                        <div class="col-6">
                            <?php
                                include_once("validate.php"); 
                                echo graphCoursesFree();
                            ?>
                        </div>                     
                        <button class="btn btn-success save" id="update">Update Course</button>
                    </div>
                </main>
