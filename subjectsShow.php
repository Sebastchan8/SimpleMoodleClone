    ...
    <head>
        ...
        <script>
            $(document).ready(function(){ 
                $('#add').click(function(){
                    <?php
                        $_SESSION['isAddingSub'] = true;
                        $_SESSION['subMod'] = "";
                        $_SESSION['desMod'] = "";
                    ?>
                    window.open("subjectsAdd.php", "_self");
                });
                ...
                $('.edit').click(function(){                    
                    ...
                    $.ajax({
                        ...
                        success: function(result){
                            <?php $_SESSION['isAddingSub'] = false;?>
                            window.open("subjectsAdd.php", "_self");
                        }
                    });
                });
            ...
            <div id="layoutSidenav_content">                
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Subjects Mananger</h1>
                        <button class="btn btn-primary save" id="add">Add Subject</button>
                        
                        <?php
                            include_once("validate.php"); 
                            echo graphSubjectsList();
                        ?>
                    </div>
                </main>
